...
var presetProviders = []Provider{
	...
	},
	{
		...
		Models: []ModelDef{
			...
			{ID: "glm-5", Name: "GLM-5", Tier: "basic", Enabled: true},
	...
	},
	{
		...
		Models: []ModelDef{
			// ===== 基础模型 =====
			{ID: "sider", Name: "Sider Fusion", Tier: "basic", Enabled: true},
			{ID: "gemini-3.5-flash-lite", Name: "Gemini 3.5 Flash Lite", Tier: "basic", Enabled: true},
			{ID: "gemini-3.5-flash-lite-think", Name: "Gemini 3.5 Flash Lite Think", Tier: "basic", Enabled: true},
			{ID: "gpt-5.6-luna", Name: "GPT-5.6 Luna", Tier: "basic", Enabled: true},
			{ID: "gpt-5.6-luna-think", Name: "GPT-5.6 Luna Think", Tier: "basic", Enabled: true},
			{ID: "glm-5", Name: "GLM-5", Enabled: true},
			{ID: "glm-5-think", Name: "GLM-5 Think", Tier: "basic", Enabled: true},
			{ID: "gemini-3.0-flash", Name: "Gemini 3.0 Flash", Tier: "basic", Enabled: true},
			{ID: "gemini-3.0-flash-think", Name: "Gemini 3.0 Flash Think", Tier: "basic", Enabled: true},
			{ID: "claude-haiku-4.5", Name: "Claude Haiku 4.5", Tier: "basic", Enabled: true},
			...
			{ID: "gemini-3.6-flash-think", Name: "Gemini 3.6 Flash Think", Tier: "advanced", Enabled: true},
			{ID: "kimi-k3", Name: "Kimi K3", Tier: "advanced", Enabled: true},
			{ID: "grok-4.5", Name: "Grok 4.5", Tier: "advanced", Enabled: true},
			{ID: "gpt-5.6-terra", Name: "GPT-5.6 Terra", Tier: "advanced", Enabled: true},
			{ID: "gpt-5.6-terra-think", Name: "GPT-5.6 Terra Think", Tier: "advanced", Enabled: true},
			{ID: "claude-sonnet-5", Name: "Claude Sonnet 5", Tier: "advanced", Enabled: true},
			{ID: "claude-sonnet-5-think", Name: "Claude Sonnet 5 Think", Tier: "advanced", Enabled: true},
			{ID: "claude-fable-5", Name: "Claude Fable 5", Tier: "advanced", Enabled: true},
			{ID: "claude-fable-5-think", Name: "Claude Fable 5 Think", Tier: "advanced", Enabled: true},
			{ID: "gpt-5.6-sol", Name: "GPT-5.6 Sol", Tier: "advanced", Enabled: true},
			...
			{ID: "gemini-2.5-pro", Name: "Gemini 2.5 Pro", Tier: "advanced", Enabled: true},
			{ID: "gpt-5.1", Name: "GPT-5.1", Tier: "advanced", Enabled: true},
			// ===== 超级高级模型 =====
			{ID: "claude-opus-4.8", Name: "Claude Opus 4.8", Tier: "super", Enabled: true},
			{ID: "claude-opus-4.8-think", Name: "Claude Opus 4.8 Think", Tier: "super", Enabled: true},
		},
