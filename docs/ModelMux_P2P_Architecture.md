...
```mermaid
graph TB
    subgraph "OpenModelPool Agent P2P 网络节点类型"
...
BitTorrent 的 TFT 机制已被证明对策略性节点不够稳健——BitTyrant 客户端可通过选择性贡献获得 70% 的性能提升 [(BitTyrant 研究)](https://people.eecs.berkeley.edu/~sylvia/cs268-2016/papers/bittyrant.pdf)。OpenModelPool Agent 借鉴其教训，设计了 **带衰减的 TFT 变体**：
